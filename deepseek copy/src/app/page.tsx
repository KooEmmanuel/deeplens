...
import { Upload, Send, FileText, Menu, X, MoreVertical, Trash2, Copy, Download, ChevronDown, ChevronUp, Settings, MessageSquare, Plus } from "lucide-react";
...
export default function Home() {
  ...
  const handleFileUpload = async (acceptedFiles: File[]) => {
    try {
      ...
      setSelectedDocumentName(newDoc.name);
